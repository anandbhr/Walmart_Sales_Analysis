# Walmart_Sales_Analysis using SQL

## Project Description
This project aims to explore the Walmart Sales data to understand the top performing branches and products, sales trend of different products, customer behaviour etc. The purpose is to study how sales strategies can be improved and optimized. The dataset was obtained from the [Kaggle Walmart Sales Forecasting Competition](https://www.kaggle.com/c/walmart-recruiting-store-sales-forecasting).
...
3. **Exploratory Data Analysis (EDA):** Exploratory data analysis is done to answer the questions and find trends in the sales dataset.
